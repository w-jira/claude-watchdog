...
python3 -m pytest tests/test_replay_health_gate.py tests/test_bootstrap.py tests/test_npm_package.py tests/test_claude_tele_tmux_env.py tests/test_dog_engine_resolution.py tests/test_claude_auth_detection.py -q
tmp_units="$(mktemp -d)"
