...
- Linux encrypted token storage uses a private colocated key file; it prevents plaintext `.env` storage but does not protect against a compromised OS account.
